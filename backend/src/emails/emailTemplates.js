...
export function createVerificationEmailTemplate(otp) {
  return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      ...
      <p style="margin-bottom: 5px;">This OTP is valid for 10 minutes.</p>
      <p style="margin-top: 0;">If you didn't request this code, please ignore this email.</p>
...
export const createResetPasswordEmailTemplate = (otp) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(to right, #06b6d4, #3b82f6); padding: 20px; text-align: center;">
  ...
  <div style="background-color: #f9fafb; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
    ...
    <div style="text-align: center; margin: 30px 0;">
      <span style="font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #06b6d4;">${otp}</span>
    </div>
